(function() {
  ...
  function lookupMatcher(availableLocales, requestedLocales) {
    ...
    if (availableLocale !== undefined) {
      var result.locale = availableLocale;
  ...
  function resolveLocale(availableLocales,
    ...
    if (matcher == 'lookup') {
      var r = lookupMatcher(availableLocales, requstedLocales);
    } else {
  ...
  if (typeof exports !== 'undefined') {
    LocaleNegotiator = exports;
  } else {
    LocaleNegotiator = this.L20n.LocaleNegotiator = {};
  }

  LocaleNegotiator.CanonicalizeLocaleList = canonicalizeLocaleList;
  LocaleNegotiator.BestAvailableLocale = bestAvailableLocale;
  LocaleNegotiator.ResolveLocale = resolveLocale;
}).call(this);
