(function() {
  ...
  function Resource(id, ctx, parser) {
    ...
    function addResource(url, async, nesting) {
      if (nesting > 7) {
        return false;
      }
  ...
  function Context(id, parentContext) {
    ...
    function addResource(uri, lang) {
      if (_settings.locales.indexOf(lang) == -1) {
        _settings.locales.push(lang);
      }
      if (!_settings.resources[lang]) {
        _settings.resources[lang] = [];
      }
      _settings.resources[lang].push(uri);
      return this;
    }
    ...
    function freeze(async) {
      ...
      if (_settings.locales.length) {
        var locale = _settings.locales[0];
        _resource.addResource(_settings.resources[locale], async, 0);
      }
    ...
    function getSubContext() {
      ...
      if (_subContext === null) {
        ...
        _subContext.settings.resources = _settings.resources;
        _subContext.addEventListener('error', echo);
        _subContext.freeze(false);
      }
      return _subContext;
    }
    ...
    Object.defineProperty(this, 'settings', {
      value: Object.create(Object.prototype, {
        ...
        resources: {
          get: function() { return _settings.resources },
          set: function(val) {
            _settings.resources = val;
            Object.freeze(_settings.resources);
          },
          configurable: false,
          enumerable: true,
        },
