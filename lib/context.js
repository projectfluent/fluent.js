(function() {
  ...
  var L20n = {
    Context: Context,
    LangPack: new Worker('../js/lib/langpack.js'),
  ...
  L20n.LangPack.addEventListener('message', function(msg) {
    ...
    switch (res.type) {
      case 'getLocales':
        console.log('==== Received locales ====');
        console.log('For domain: ' + res.domain);
        console.log('Locales: ' + res.locales); 
        break;
      case 'getResource':
        console.log('==== Received resource ====');
        console.log('For locale: ' + res.locale);
        console.log('For domain: ' + res.domain);
  ...
  function Context(id) {
    ...
    function getLocalesFromLangPackService() {
      ...
      L20n.LangPack.postMessage({
        type: 'getLocales',
        domain: 'http://browser.gaiamobile.org',  // ctx.id
      });
