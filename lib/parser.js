(function() {
  ...
  function Parser(Emitter) {
    ...
    function getArray() {
      ...
      return {
        type: 'Array',
        data: getItemListSoftTrailComma(getValue, ']')
      };
    }
    ...
    function getString(opchar) {
      ...
      if (_compile) {
        ...
        return _parser.parseString(str);
      }
    ...
    function getIdentifier() {
      ...
      return {
        type: 'Identifier',
        name: _source.slice(start, _index)
      };
    }
    ...
    function getPrimaryExpression() {
      ...
      if (pos > _index) {
        ...
        return {
          type: 'Number',
          data: parseInt(_source.slice(start, pos), 10)
        };
      }
