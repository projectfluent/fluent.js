...
Env.prototype.request = function(langs) {
  return this._negotiate(langs).then(function(supported) {
...
Env.prototype.require = function(langs, resIds) {
  return this._negotiate(langs).then(function(supported) {
    var ctx = new Context(this, supported, resIds);
...
Env.prototype._negotiate = function(langs) {
  return this.registered.then(function() {
    return Intl.prioritizeLocales(this.available, langs, this.default);
  }.bind(this));
};
